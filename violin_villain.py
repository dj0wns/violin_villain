...
def draw_staff(note_dict, max_note_position):
  ...
  #flip Y
  pygame.draw.line(screen, (0, 0, 0), (0,  GAME_Y - (GAME_Y * scalar) + WORLD_SCALAR * 2), (GAME_X, GAME_Y - (GAME_Y * scalar) + WORLD_SCALAR * 2), WORLD_SCALAR * 5)
